...
- **Track your activity** — see your creative output, contributions, and AI usage in Settings → Usage.
...
<CardGroup cols="2">
  ...
  <Card title="Usage" icon="chart-line" color="#7c7c7c" href="/v2/michelangelo-app/usage">
    Track your creative output, contributions, and AI usage.
  </Card>
</CardGroup>
