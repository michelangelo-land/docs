...
Open **Settings → Account → Usage** to see your creative output (lines of code, files, streaks, best month, peak hour), your contributions calendar, and your per-month and all-time stats (apps generated, AI generations, tokens used).

See the <a href="/v2/michelangelo-app/usage">Usage</a> page for metric definitions.
