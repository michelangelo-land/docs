...
<Tabs>
  <Tab title="Claude">
    ...
    On first use, a browser window opens the Michelangelo consent screen. Sign in, approve, and you're connected — Claude handles registration and tokens for you.
  </Tab>
  <Tab title="Cursor">
