...
<CardGroup cols={1}>
  ...
  <Card title="expo-selectable-text">
  ...
  <Card title="@pachun/use-expo-push-notifications">
  ...
  <Card title="expo-notifee-plugin">
  ...
  <Card title="expo-health-connect">
    Expo integration for react-native-health-connect.
  </Card>

  <Card title="@wwdrew/expo-android-account-manager">
    Expo Module for Android AccountManager.
  </Card>

  <Card title="@wwdrew/expo-android-shared-preferences">
  ...
  <Card title="expo-dynamic-app-icon">
