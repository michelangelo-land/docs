...
<CardGroup cols={1}>
  ...
  <Card title="expo-face-detector">
    ...
    ⚠️ This library is not actively maintained. You can use [**react-native-vision-camera**](https://reactnative.directory/?search=react-native-vision-camera) instead.
  </Card>
  ...
  <Card title="expo-barcode-scanner">
    ...
    ⚠️ This library is not actively maintained. You can use [expo-camera](https://reactnative.directory/?search=expo-camera)  instead.
  </Card>
</CardGroup>
