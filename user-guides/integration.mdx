---
title: "Integration"
description: "In this section, we will explore the integrations available on **Code** by michelangelo.land, focusing on the supported APIs and the integration with GitHub."
mode: "wide"
---
...
Verified Integrations are those that we have tested and are testing to work perfectly in the <a href="https://code.michelangelo.land">Code</a> environment. These are mainly libraries that start with the prefix "expo-" and are compatible with Expo Go.
...
Unverified Integrations include all those libraries and APIs that are compatible with Expo Go, but have not yet been thoroughly tested within <a href="https://code.michelangelo.land">Code</a>.
